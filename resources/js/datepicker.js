...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (dateRangePickerEl !== null) {
        ...
        const startDateInput = dateRangePickerEl.querySelector(
            'input[name="start"]'
        )
        const endDateInput =
            dateRangePickerEl.querySelector('input[name="end"]')
        ...
        function handleDateChange(e) {
            ...
            if (startDate && endDate) {
                window.livewire.emit("dateRangeChanged", {
                    start: startDate,
                    end: endDate,
                })
            }
