<div class="grid grid-cols-12 items-end gap-2 mb-2" x-data="{
    ...
    <div class="col-span-12 lg:col-span-2 ">
        <div class="bg-white flex items-center p-4 border border-[#D4DDD7] rounded">
    ...
    <div
        class="lg:col-span-10 px-4 py-3 bg-white border border-[#D4DDD7] rounded flex flex-wrap items-center gap-2.5 text-sm">
                    ...
                    <form class="w-[20rem]" @submit.prevent="updateValue">
                        <div class="px-6 pt-6">
                            <div class="flex justify-between">
                                <span class="font-medium text-base">Transaction Value (in thousands)</span>
