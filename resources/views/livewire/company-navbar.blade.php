    ...
    <div class="px-2 mx-auto max-w-7xl sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-8">
        <nav class="hidden lg:flex lg:py-2" aria-label="Global">
            ...
            <div class="lg:space-x-4">
                <livewire:company-navbar-item href="/company/{{ $company->ticker }}" name="Product" route="company.show" />
                <livewire:company-navbar-item href="/company/{{ $company->ticker }}/metrics" name="Metrics"
                    route="company.metrics" />
                <livewire:company-navbar-item href="/company/{{ $company->ticker }}/calcbench" name="c/ Calcbench"
                    route="company.calcbench" />
                <livewire:company-navbar-item href="/company/{{ $company->ticker }}/report" name="Full report"
                    route="company.report" />
                <livewire:company-navbar-item href="/company/{{ $company->ticker }}/periods" name="F.R. by period"
                    route="company.periods" />
                <livewire:company-navbar-item href="/company/{{ $company->ticker }}/sc2" name="Harmonization Sc2"
                    route="company.sc2" />
                <livewire:company-navbar-item href="/company/{{ $company->ticker }}/sc3" name="Harmonization Sc"
                    route="company.sc3" />
            </div>
