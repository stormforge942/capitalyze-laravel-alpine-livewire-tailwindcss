<div>
        ...
        <div class="h-full px-6 pb-4 bg-white dark:bg-gray-800 flex flex-col">
            ...
            <div class="mb-12">
                <a href="{{ route('home') }}">
                    ...
                    <svg id="collapsed-logo" class="hidden" width="32" height="32" viewBox="0 0 32 32"
                    ...
                    <a data-tooltip-target="tooltip-Analysis" data-tooltip-placement="right" id="nav"
                        ...
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                            ...
                            <path
                                ...
                                stroke="#464E49" stroke-width="1.33333" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M1.37109 13.0104L5.42963 8.91009L7.62273 11.0104L10.3038 8.66699L11.7973 10.123"
                                stroke="#464E49" stroke-width="1.33333" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M14.6667 6V12.3333C14.6667 12.8856 14.219 13.3333 13.6667 13.3333H4"
                                stroke="#464E49" stroke-width="1.33333" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M6.37109 4.66699H12.3711" stroke="#464E49" stroke-width="1.33333"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.70312 4.66699H4.36979" stroke="#464E49" stroke-width="1.33333"
                                stroke-linecap="round" stroke-linejoin="round" />
                ...
                @if (count($navbarItems))
                    <li>
                        <button data-dropdown-toggle="dropdownMore" data-dropdown-placement="left-end"
                            ...
                            <div class="flex items-center">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#464E49" stroke-width="1.83333" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path
                            ...
                            <svg id="tag-collapsed" width="16" height="16" viewBox="0 0 16 16"
            ...
            <button id="profileButton" data-dropdown-toggle="dropdownProfile" data-dropdown-placement="left-end"
                ...
                <svg id="tag-collapsed" class="ml-[10px]" width="16" height="16" viewBox="0 0 16 16"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    @push('scripts')
        <script>
            ...
            let collapsed = localStorage.getItem('company-nav-collapsed') === 'true';

            handleNav(collapsed)

            collapseButton.addEventListener('click', () => {
                collapsed = !collapsed;
                localStorage.setItem('company-nav-collapsed', collapsed);
                handleNav(collapsed)
            });

            function handleNav(collapsed) {
                if (!collapsed) {
                    // uncollapsed
