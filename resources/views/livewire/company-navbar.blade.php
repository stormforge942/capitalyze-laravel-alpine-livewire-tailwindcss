<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-10 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 !transition-all" aria-label="Sidebar">
   <div class="h-full px-6 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      ...
      <ul class="space-y-2 font-medium">
         <li id="nav" class="flex items-center p-2 font-bold rounded-lg group text-[#3561E7] rounded w-full font-bold">
         ...
         <li>
            ...
            <div id="tooltip-Overwiew" role="tooltip" class="hidden absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
               Overwiew
         ...
         <li>
            <a data-tooltip-target="tooltip-Financials" data-tooltip-placement="right" id="nav" href="{{ route('company.report', ['ticker' => $this->company->ticker]) }}" class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'company.report') bg-[#52d3a233] font-bold @endif rounded-lg group">
               <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M6.98879 8.32031H4.7313C4.48632 8.32031 4.28613 8.51786 4.28613 8.76548V15.5538C4.28613 15.7987 4.48368 15.9989 4.7313 15.9989H6.98879C7.23376 15.9989 7.43395 15.8013 7.43395 15.5538V8.76283C7.43395 8.51786 7.23641 8.32031 6.98879 8.32031ZM5.17911 15.1086V9.20804H6.54627V15.1086H5.17911Z" fill="#464E49"/>
                  <path d="M11.272 4.96387H9.0145C8.76953 4.96387 8.56934 5.16141 8.56934 5.40903V15.5533C8.56934 15.7982 8.76692 15.9984 9.0145 15.9984H11.272C11.517 15.9984 11.7172 15.8009 11.7172 15.5533V5.40642C11.7145 5.16145 11.517 4.96387 11.272 4.96387ZM10.8268 15.1081H9.45971V5.85159H10.8268V15.1081Z" fill="#464E49"/>
                  <path d="M15.5552 1.60254H13.2977C13.0527 1.60254 12.8525 1.80008 12.8525 2.0477V15.5479C12.8525 15.7928 13.0501 15.993 13.2977 15.993H15.5552C15.8002 15.993 16.0004 15.7954 16.0004 15.5479V2.05035C15.9977 1.80538 15.8002 1.60254 15.5552 1.60254ZM15.11 15.108H13.7429V2.49556H15.11V15.108Z" fill="#464E49"/>
                  <path d="M9.09618 0.000976562H6.77285C6.52788 0.000976562 6.32768 0.198561 6.32768 0.446142C6.32768 0.693764 6.52527 0.891307 6.77285 0.891307H8.02408L0.18216 8.72801C0.00829051 8.90188 0.00829051 9.18108 0.18216 9.3576C0.340219 9.51301 0.693173 9.47613 0.811748 9.3576L8.65102 1.51829V2.76952C8.65102 3.01449 8.84856 3.21468 9.09618 3.21468C9.34116 3.21468 9.54135 3.01714 9.54135 2.76952V0.446183C9.54135 0.201169 9.34381 0.000976562 9.09618 0.000976562Z" fill="#464E49"/>
                  </g>
                  <defs>
            ...
            <div id="tooltip-Financials" role="tooltip" class="hidden absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
               Financials
               <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
         </li>
         <li>
            <a data-tooltip-target="tooltip-Analysis" data-tooltip-placement="right" id="nav" href="{{ route('company.profile', ['ticker' => $this->company->ticker]) }}" class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'analysis') bg-[#52d3a233] font-bold @endif rounded-lg group">
               <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14.6663 3.66699C14.6663 3.11471 14.2186 2.66699 13.6663 2.66699H2.33301C1.78072 2.66699 1.33301 3.11471 1.33301 3.66699V6.66699H14.6663V3.66699Z" stroke="#464E49" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M1.37109 13.0104L5.42963 8.91009L7.62273 11.0104L10.3038 8.66699L11.7973 10.123" stroke="#464E49" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
         ...
         <li>
            ...
            <div id="tooltip-Settings" role="tooltip" class="hidden absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
               Settings
               <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
         </li>
         <li>
            <button data-dropdown-toggle="dropdownMore" data-dropdown-placement="left-end" aria-controls="dropdown-more" data-collapse-toggle="dropdown-more" id="nav" class="w-full flex items-center justify-between p-2 text-[#464E49] hover:bg-[#828c851a] rounded-lg group">
               <div class="flex items-center">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M11.3369 11.9982C11.3369 12.3664 11.6354 12.6649 12.0036 12.6649C12.3718 12.6649 12.6702 12.3664 12.6702 11.9982C12.6702 11.63 12.3718 11.3315 12.0036 11.3315C11.6354 11.3315 11.3369 11.63 11.3369 11.9982Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M7.33691 11.9982C7.33691 12.3664 7.63538 12.6649 8.00358 12.6649C8.37178 12.6649 8.67025 12.3664 8.67025 11.9982C8.67025 11.63 8.37178 11.3315 8.00358 11.3315C7.63538 11.3315 7.33691 11.63 7.33691 11.9982Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M3.33691 11.9982C3.33691 12.3664 3.63539 12.6649 4.00358 12.6649C4.37177 12.6649 4.67025 12.3664 4.67025 11.9982C4.67025 11.63 4.37177 11.3315 4.00358 11.3315C3.63539 11.3315 3.33691 11.63 3.33691 11.9982Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M11.3369 7.99821C11.3369 8.36641 11.6354 8.66488 12.0036 8.66488C12.3718 8.66488 12.6702 8.36641 12.6702 7.99821C12.6702 7.63001 12.3718 7.33154 12.0036 7.33154C11.6354 7.33154 11.3369 7.63001 11.3369 7.99821Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M7.33691 7.99821C7.33691 8.36641 7.63538 8.66488 8.00358 8.66488C8.37178 8.66488 8.67025 8.36641 8.67025 7.99821C8.67025 7.63001 8.37178 7.33154 8.00358 7.33154C7.63538 7.33154 7.33691 7.63001 7.33691 7.99821Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M3.33691 7.99821C3.33691 8.36641 3.63539 8.66488 4.00358 8.66488C4.37177 8.66488 4.67025 8.36641 4.67025 7.99821C4.67025 7.63001 4.37177 7.33154 4.00358 7.33154C3.63539 7.33154 3.33691 7.63001 3.33691 7.99821Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M11.3369 3.99821C11.3369 4.3664 11.6354 4.66488 12.0036 4.66488C12.3718 4.66488 12.6702 4.3664 12.6702 3.99821C12.6702 3.63002 12.3718 3.33154 12.0036 3.33154C11.6354 3.33154 11.3369 3.63002 11.3369 3.99821Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M7.33691 3.99821C7.33691 4.3664 7.63538 4.66488 8.00358 4.66488C8.37178 4.66488 8.67025 4.3664 8.67025 3.99821C8.67025 3.63002 8.37178 3.33154 8.00358 3.33154C7.63538 3.33154 7.33691 3.63002 7.33691 3.99821Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                     <path d="M3.33691 3.99821C3.33691 4.3664 3.63539 4.66488 4.00358 4.66488C4.37177 4.66488 4.67025 4.3664 4.67025 3.99821C4.67025 3.63002 4.37177 3.33154 4.00358 3.33154C3.63539 3.33154 3.33691 3.63002 3.33691 3.99821Z" stroke="#464E49" stroke-width="1.83333" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>

                  <span class="ml-3" id="collapsed-span">More</span>
               </div>

               <svg id="tag-collapsed" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.78126 8.00047L5.48145 4.70062L6.42425 3.75781L10.6669 8.00047L6.42425 12.2431L5.48145 11.3003L8.78126 8.00047Z" fill="#464E49"/>
               </svg>
            </button>
            ...
            <div id="dropdownMore" class="h-52 overflow-y-scroll invisible h-[0px] w-[0px] hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
      ...
      <button id="profileButton" data-dropdown-toggle="dropdownProfile" data-dropdown-placement="left-end" type="button" class="mt-5 inline-flex items-center font-bold text-sm leading-4 focus:outline-none transition">
         ...
         <svg id="tag-collapsed" class="ml-[10px]" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.00033 2C7.26699 2 6.66699 2.6 6.66699 3.33333C6.66699 4.06667 7.26699 4.66667 8.00033 4.66667C8.73366 4.66667 9.33366 4.06667 9.33366 3.33333C9.33366 2.6 8.73366 2 8.00033 2ZM8.00033 11.3333C7.26699 11.3333 6.66699 11.9333 6.66699 12.6667C6.66699 13.4 7.26699 14 8.00033 14C8.73366 14 9.33366 13.4 9.33366 12.6667C9.33366 11.9333 8.73366 11.3333 8.00033 11.3333ZM8.00033 6.66667C7.26699 6.66667 6.66699 7.26667 6.66699 8C6.66699 8.73333 7.26699 9.33333 8.00033 9.33333C8.73366 9.33333 9.33366 8.73333 9.33366 8C9.33366 7.26667 8.73366 6.66667 8.00033 6.66667Z" fill="black"/>
         </svg>
      </button>
