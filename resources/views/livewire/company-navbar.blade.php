<div>
   <aside id="default-sidebar"
      class="fixed top-0 left-0 z-40 w-64 h-screen pt-10 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 !transition-all"
      aria-label="Sidebar">
      <div class="h-full px-6 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
         ...
         <ul class="space-y-2 font-medium">
            <li id="nav"
               class="flex items-center p-2 font-bold rounded-lg group text-[#3561E7] rounded w-full font-bold">
            ...
            <li>
               <a data-tooltip-target="tooltip-Overwiew" data-tooltip-placement="right" id="nav"
                  ...
                  class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'company.profile') bg-[#52d3a233] font-bold @endif rounded-lg group">
            ...
            <li>
               <a data-tooltip-target="tooltip-Financials" data-tooltip-placement="right" id="nav"
                  ...
                  class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'company.report') bg-[#52d3a233] font-bold @endif rounded-lg group">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
               <a data-tooltip-target="tooltip-Analysis" data-tooltip-placement="right" id="nav"
                  href="{{ route('company.profile', ['ticker' => $this->company->ticker]) }}"
                  class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'analysis') bg-[#52d3a233] font-bold @endif rounded-lg group">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
            ...
            <li>
               <a data-tooltip-target="tooltip-Filings" data-tooltip-placement="right" id="nav"
                  href="{{ route('company.profile', ['ticker' => $this->company->ticker]) }}"
                  class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'filings') bg-[#52d3a233] font-bold @endif rounded-lg group">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
            ...
            <li>
               <a data-tooltip-target="tooltip-Ownership" data-tooltip-placement="right" id="nav"
                  href="{{ route('company.profile', ['ticker' => $this->company->ticker]) }}"
                  class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'ownership') bg-[#52d3a233] font-bold @endif rounded-lg group">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
            ...
            <li>
               <a data-tooltip-target="tooltip-Settings" data-tooltip-placement="right" id="nav"
                  href="{{ route('company.profile', ['ticker' => $this->company->ticker]) }}"
                  class="flex items-center p-2 text-[#464E49] hover:bg-[#828c851a] @if($currentRoute === 'settings') bg-[#52d3a233] font-bold @endif rounded-lg group">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
               <button data-dropdown-toggle="dropdownMore" data-dropdown-placement="left-end"
                  ...
                  class="w-full flex items-center justify-between p-2 text-[#464E49] hover:bg-[#828c851a] rounded-lg group">
         ...
         <div id="dropdownProfile"
            ...
            <div class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownTopButton">
               ...
               @if (Auth::user() && Auth::user()->isAdmin())
               <x-jet-dropdown-link href="{{ route('admin.navbar-management') }}"
                  :active="request()->routeIs('admin.navbar-management')">
