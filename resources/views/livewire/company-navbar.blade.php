         ...
         <ul class="space-y-2 text-[14px] flex-1">
            ...
            <li>
               <a data-tooltip-target="tooltip-Overwiew" data-tooltip-placement="right" id="nav"
                  ...
                  class="flex items-center p-2 text-dark-light hover:bg-[#828c851a] @if($currentRoute === 'company.profile' || $currentRoute === 'company.product') bg-[#52d3a233] font-medium @endif rounded-lg group">
