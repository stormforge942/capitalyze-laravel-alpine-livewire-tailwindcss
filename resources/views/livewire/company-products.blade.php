                                                        ...
                                                        <td class="whitespace-nowrap px-2 py-2 text-sm text-gray-900">
                                                            <div class="flex flex-row justify-between items-center space-x-2">
                                                                ...
                                                                @if(auth()->user()->hasNavbar('create.company.segment.report'))
                                                                    <span wire:click="$emit('slide-over.open', 'company-segment-report-slide', [{{ $products[$date][$segment] }}, '{{ $date }}', '{{request()->fullUrl()}}'])" class="whitespace-nowrap text-sm text-gray-900">
