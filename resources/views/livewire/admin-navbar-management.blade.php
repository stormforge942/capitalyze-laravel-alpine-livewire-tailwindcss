        ...
        <div class="mt-4 px-4 sm:px-6 lg:px-8 bg-white py-4 shadow rounded w-full md:w-2/3 md:mx-auto">
            ...
            <div class="w-full table-fixed border-collapse">
                <table class="table-auto w-full overflow-scroll">
                    <thead>
                        <tr class="block">
                            <th class="font-semibold py-4 text-left py-[5px] px-[10px] w-[200px]">Route</th>
                            <th class="pr-5 py-[5px] px-[10px] w-[200px]">Is Moddable</th>
                            @foreach ($groups as $group)
                            <th class="font-semibold pr-5 py-[5px] px-[10px] w-[200px]">Show For {{ $group->name }}</th>
                            @endforeach
                        </tr>
                    </thead>
