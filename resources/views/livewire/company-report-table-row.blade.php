        ...
        <div
            ...
            title="{{$data['title']}}">
                <div class="ml-4 flex items-center justify-center" style="margin-left: {{$index * 20}}px;">
                    ...
                    @elseif(!$open)
                        <svg wire:click="toggle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-2 hover:cursor-pointer hover:text-blue-400">
