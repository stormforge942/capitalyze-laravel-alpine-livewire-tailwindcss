   ...
   <div>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <x-jet-nav-link href="{{ route('japan.metrics', ['ticker' => $japan->symbol]) }}" :active="request()->routeIs('japan.metrics')">
                    {{ __('Metrics') }}
                    </x-jet-nav-link>
                </li>
                <li>
                    <x-jet-nav-link href="{{ route('japan.filings', ['ticker' => $japan->symbol]) }}" :active="request()->routeIs('japan.filings')">
                    {{ __('Filings') }}
                    </x-jet-nav-link>
                </li>
            </ul>
