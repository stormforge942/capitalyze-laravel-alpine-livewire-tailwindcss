        ...
        <div class="graph-wrapper">
            <div class="graph-header">
                ...
                <div class="select-graph-date-wrapper ml-12 flex">
                    <form class="select-graph-date-wrapper ml-12 flex">
                        <ul class="items-center w-full flex">
                            <li class="w-full mr-6">
                                <input  wire:model="currentChartPeriod" value="3m" id="date-3m" type="radio" name="date-range" name="radio-group" checked>
                                <label for="date-3m">3m</label>
                            </li>
                            <li class="w-full mr-6">
                                <input wire:model="currentChartPeriod" value="6m" id="date-6m" type="radio" name="date-range" name="radio-group" checked>
                                <label for="date-6m">6m</label>
                            </li>
                            <li class="w-full mr-6">
                                <input wire:model="currentChartPeriod" value="YTD" id="date-1yr" type="radio" name="date-range">
                                <label for="date-1yr">YTD</label>
                            </li>
                            <li class="w-full mr-6">
                                <input wire:model="currentChartPeriod" value="1yr" id="date-1yr2" type="radio" name="date-range">
                                <label for="date-1yr2">1yr</label>
                            </li>
                            <li class="w-full mr-6">
                                <input wire:model="currentChartPeriod" value="5yr" id="date-5yr" type="radio" name="date-range">
                                <label for="date-5yr">5yr</label>
                            </li>
                            <li class="w-full mr-6">
                                <input wire:model="currentChartPeriod" value="max" id="date-5yr2" type="radio" name="date-range">
