<div class="relative graph-wrapper-box w-full" x-data="{ collapse: false }">
    <div class="graph-wrapper" x-show="!collapse">
        <div class="graph-header relative">
           ...
           <div class="custom-dropdown-absolute-wrapper">
            <div class="relative flex justify-end" x-data="{
                chartMenuOpen: false
            }">
                <div>
                  <button type="button" @click="chartMenuOpen = !chartMenuOpen" class="custom-drop-down-button" id="menu-button" aria-expanded="true" aria-haspopup="true">
                ...
                <div x-show="chartMenuOpen" class="absolute custom-drop-down right-0 z-10    bg-white  focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                  <div class="py-1" role="none">
                    <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                   <div class="links-wrapper mb-3">
                    <a href="#" class="menu_link" role="menuitem" tabindex="-1" id="menu-item-0">Hide Chart</a>
