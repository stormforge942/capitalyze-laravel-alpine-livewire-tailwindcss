<div>
    ...
    @else
        ...
        <div class="flow-root mt-8 overflow-x-hidden company-profile-loading">
            <div class="align-middle">
                <div class="inline-block min-w-full sm:rounded-lg">
                    <div wire:loading.flex class="items-center justify-center">
                            <div class="grid h-full place-content-center" role="status">
                            ...
                            <div class="flex items-center select-wrapper">
                                <div class="flex items-center ml-3">View
                                    ...
                                    <div id="dropdown-View" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700 dark:divide-gray-600">
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40" aria-labelledby="dropdownViewButton">
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="view-radio-1" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="view-radio-2" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Adjusted</div>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="view-radio-3" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="view-radio-4" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Per Share</div>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="view-radio-5" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Common size</div>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40" aria-labelledby="dropdownViewButton">
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="unitType-radio-1" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Thousands</div>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="unitType-radio-2" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Millions</div>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="unitType-radio-3" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Billions</div>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40" aria-labelledby="dropdownViewButton">
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="template-radio-1" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Standart</div>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40" aria-labelledby="dropdownViewButton">
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="order-radio-1" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40" aria-labelledby="dropdownViewButton">
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="freezePanes-radio-1" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Top Row</div>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="freezePanes-radio-2" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                            ...
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="freezePanes-radio-3" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40" aria-labelledby="dropdownViewButton">
                                            <li>
                                                <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="decimal-radio-1" class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>.00</div>
                                                        </label>
                                                    </div>
                                                </div>
                            ...
                            <div class="flex flex-col w-full px-5 pb-5 my-4 bg-white">
                                <div class="flex justify-between w-10/12 pl-6 pr-3 my-12">
                                    ...
                                    <div class="flex items-start">
                                        <span class="flex items-center justify-center w-5 h-5 text-white bg-red-500 border-2 rounded-full">
                                ...
                                <div class="flex flex-wrap items-end justify-start w-full px-2 mt-8 space-x-3 space-y-3">
