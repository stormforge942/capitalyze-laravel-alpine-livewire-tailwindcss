<div>
    @if ($noData)
        <div>
            <div class="flex mx-auto">
                <div class="w-full px-4 py-4 mt-4 bg-white rounded shadow sm:px-6 lg:px-8 md:w-1/2 md:mx-auto">
    ...
    @else
        <div class="flow-root mt-0 overflow-x-hidden company-profile-loading">
            <div class="align-middle">
                <div class="block min-w-full sm:rounded-lg">
                    <div class="py-0">
                        <div class="flex items-center justify-between w-full">
                            <div class="page-titles">
                                <b>{{ @$companyName }} @if (@$ticker)
                                        ({{ @$ticker }})
                                    @endif </b> <br>
                                <b>$345</b> <small class="text-color-green">(+0.40%)</small>
                            </div>
                            <div class="flex download-buttons-wrapper">
                        ...
                        <div class="flex tabs-wrapper">
                            <a href="{{ route('company.report', ['ticker' => $company->ticker, 'period' => $period]) }}" @class([
                                'tab',
                                'px-3',
                            ...
                            <a href="{{ route('company.geographic', ['ticker' => $company->ticker, 'period' => $period]) }}" @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.geographic',
                            ])>Segments</a>
                            <a href="{{ route('company.shareholders', ['ticker' => $company->ticker, 'period' => $period]) }}" @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.shareholders',
                            ])>Ratios</a>
                            <a href="{{ route('company.executive.compensation', ['ticker' => $company->ticker, 'period' => $period]) }}" @class([
                                'tab',
                                'px-3',
                        ...
                        <div class="flex w-full overflow-x-hidden">
                            <div class="tabs-container" style="overflow-x: auto; white-space: nowrap;">
                                <ul class="flex tabs-wrapper">
                                    @foreach ($navbar[$activeIndex] as $key => $value)
                                        <li data-tab-id="{{ $value['id'] }}"
                                            class="whitespace-nowrap min-w-min p-4 border-b-2 max-h-[50px] overflow-hidden rounded-t-lg cursor-pointer border-transparent text-[#828C85] hover:text-[#828C85] px-6 tab @if ($value['id'] == $activeSubIndex) active @endif"
                                            wire:click="$emit('tabSubClicked', '{{ $value['id'] }}')">
                                            {{ preg_replace('/\[[^\]]*?\]/', '', $value['title']) }}</li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="filters-row">
                            <div class="flex items-center select-wrapper">
                                <div class="flex items-center ml-3">View
                                    <button type="submit" id="dropdownViewButton"
                                        data-dropdown-toggle="dropdown-View"
                                        class="flex items-center p-1 ml-2 text-sm text-gray-900 border border-gray-700 flowbite-select bg-gray-50"
                                        name="view" id="">
                                        {{ $view }}
                                    ...
                                    <div id="dropdown-View"
                                        ...
                                        <div class="flex items-center justify-between p-3 text-sm">
                                            <div>View</div>
                                            <svg id="viewClose" width="24" height="24"
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                            aria-labelledby="dropdownViewButton">
                                            <li>
                                                <div
                                                    class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="view"
                                                            @if ($view === 'As reported (Harmonized)') checked @endif
                                                            id="view-radio-1" name="view-radio"
                                                            type="radio" value="As reported (Harmonized)"
                                                    ...
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="view-radio-1"
                                                            class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="view"
                                                            @if ($view === 'Adjusted') checked @endif
                                                            id="view-radio-2" name="view-radio"
                                                            type="radio" value="Adjusted"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                                    <div class="ml-4 text-sm cursor-pointer">
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="view"
                                                            @if ($view === 'Standardised Template') checked @endif
                                                            id="view-radio-3" name="view-radio"
                                                            type="radio" value="Standardised Template"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                                    <div class="ml-4 text-sm cursor-pointer">
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="view"
                                                            @if ($view === 'Per Share') checked @endif
                                                            id="view-radio-4" name="view-radio"
                                                            type="radio" value="Per Share"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                                    <div class="ml-4 text-sm cursor-pointer">
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="view"
                                                            @if ($view === 'Common size') checked @endif
                                                            id="view-radio-5" name="view-radio"
                                                            type="radio" value="Common size"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                                    <div class="ml-4 text-sm cursor-pointer">
                                        ...
                                        <div class="mx-3 my-4">
                                            <button
                                                class="w-full p-1 text-sm bg-[#52D3A2] rounded text-center"
                                                id="viewCloseButton">Show Result</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center ml-3">Unit Type
                                    <button type="submit" id="dropdownUnitTypeButton"
                                        data-dropdown-toggle="dropdown-UnitType"
                                        class="flex items-center p-1 ml-2 text-sm text-gray-900 border border-gray-700 flowbite-select bg-gray-50"
                                        name="view" id="">
                                        {{ $unitType }}
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                    ...
                                    <!-- Dropdown menu -->
                                    <div id="dropdown-UnitType"
                                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700 dark:divide-gray-600">
                                        <div class="flex items-center justify-between p-3 text-sm">
                                            <div>Unit Type</div>
                                            <svg id="unitTypeClose" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M6.4 19L5 17.6L10.6 12L5 6.4L6.4 5L12 10.6L17.6 5L19 6.4L13.4 12L19 17.6L17.6 19L12 13.4L6.4 19Z"
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                            ...
                                            <li>
                                                <div
                                                    class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="unitType"
                                                            @if ($view === 'None') checked @endif
                                                            id="unitType-radio-1" name="unitType-radio"
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="unitType"
                                                            @if ($view === 'Thousands') checked @endif
                                                            id="unitType-radio-1" name="unitType-radio"
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="unitType"
                                                            @if ($view === 'Millions') checked @endif
                                                            id="unitType-radio-2" name="unitType-radio"
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="unitType"
                                                            @if ($view === 'Billions') checked @endif
                                                            id="unitType-radio-3" name="unitType-radio"
                                        ...
                                        <div class="mx-3 my-4">
                                            <button
                                                class="w-full p-1 text-sm bg-[#52D3A2] rounded text-center"
                                                id="unitTypeCloseButton">Show Result</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center ml-3">Template
                                    <button type="submit" id="dropdownTemplateButton"
                                        data-dropdown-toggle="dropdown-Template"
                                        class="flex items-center p-1 ml-2 text-sm text-gray-900 border border-gray-700 flowbite-select bg-gray-50"
                                        name="view" id="">
                                        {{ $template }}
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                    ...
                                    <div id="dropdown-Template"
                                        ...
                                        <div class="flex items-center justify-between p-3 text-sm">
                                            <div>Template</div>
                                            <svg id="templateClose" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M6.4 19L5 17.6L10.6 12L5 6.4L6.4 5L12 10.6L17.6 5L19 6.4L13.4 12L19 17.6L17.6 19L12 13.4L6.4 19Z"
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                            ...
                                            <li>
                                                <div
                                                    class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="template"
                                                            @if ($view === 'Standart') checked @endif
                                                            id="template-radio-1" name="template-radio"
                                                            type="radio" value="Standart"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                                    <div class="ml-4 text-sm cursor-pointer">
                                                        <label for="template-radio-1"
                                                            class="font-medium text-gray-900 cursor-pointer dark:text-gray-300">
                                                            <div>Standart</div>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="mx-3 my-4">
                                            <button
                                                class="w-full p-1 text-sm bg-[#52D3A2] rounded text-center"
                                                id="templateCloseButton">Show Result</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center ml-3">Order
                                    <button type="submit" id="dropdownOrderButton"
                                        data-dropdown-toggle="dropdown-Order"
                                        class="flex items-center p-1 ml-2 text-sm text-gray-900 border border-gray-700 flowbite-select bg-gray-50"
                                        name="view" id="">
                                    ...
                                    <div id="dropdown-Order"
                                        ...
                                        <div class="flex items-center justify-between p-3 text-sm">
                                            <div>Order</div>
                                            <svg id="orderClose" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M6.4 19L5 17.6L10.6 12L5 6.4L6.4 5L12 10.6L17.6 5L19 6.4L13.4 12L19 17.6L17.6 19L12 13.4L6.4 19Z"
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                            ...
                                            <li>
                                                <div
                                                    class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:click="toggleReverse"
                                                            @if ($reverse === false) checked @endif
                                                            id="order-radio-1" name="order-radio"
                                ...
                                <div class="flex items-center ml-3">Freeze Panes
                                    <button type="submit" id="dropdownFreezePanesButton"
                                        data-dropdown-toggle="dropdown-FreezePanes"
                                        class="flex items-center p-1 ml-2 text-sm text-gray-900 border border-gray-700 flowbite-select bg-gray-50"
                                        name="view" id="">
                                        {{ $freezePanes }}
                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                    ...
                                    <div id="dropdown-FreezePanes"
                                        ...
                                        <div class="flex items-center justify-between p-3 text-sm">
                                            ...
                                            <svg id="freezePanesClose" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M6.4 19L5 17.6L10.6 12L5 6.4L6.4 5L12 10.6L17.6 5L19 6.4L13.4 12L19 17.6L17.6 19L12 13.4L6.4 19Z"
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="freezePanes"
                                                            @if ($view === 'Top Row') checked @endif
                                                            id="freezePanes-radio-1"
                                                            name="freezePanes-radio" type="radio"
                                                            value="Top Row"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                                    <div class="ml-4 text-sm cursor-pointer">
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="freezePanes"
                                                            @if ($view === 'First Column') checked @endif
                                                            id="freezePanes-radio-2"
                                                            name="freezePanes-radio" type="radio"
                                                            value="First Column"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="freezePanes"
                                                            @if ($view === 'Top Row & First Column') checked @endif
                                                            id="freezePanes-radio-3"
                                                            name="freezePanes-radio" type="radio"
                                ...
                                <div class="flex items-center ml-3">Decimal
                                    <button type="submit" id="dropdownDecimalButton"
                                        data-dropdown-toggle="dropdown-Decimal"
                                        class="flex items-center p-1 ml-2 text-sm text-gray-900 border border-gray-700 flowbite-select bg-gray-50"
                                        name="view" id="">
                                    ...
                                    <div id="dropdown-Decimal"
                                        ...
                                        <div class="flex items-center justify-between p-3 text-sm">
                                            <div>Decimal</div>
                                            <svg id="decimalClose" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M6.4 19L5 17.6L10.6 12L5 6.4L6.4 5L12 10.6L17.6 5L19 6.4L13.4 12L19 17.6L17.6 19L12 13.4L6.4 19Z"
                                        ...
                                        <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                            ...
                                            <li>
                                                <div
                                                    class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="decimalDisplay"
                                                            @if ($decimalDisplay === '0') checked @endif
                                                            id="decimal-radio-1" name="decimal-radio"
                                                            type="radio" value="0"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                                    <div class="ml-4 text-sm cursor-pointer">
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="decimalDisplay"
                                                            @if ($decimalDisplay === '2') checked @endif
                                                            id="decimal-radio-1" name="decimal-radio"
                                                            type="radio" value="2"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="flex items-center h-5 cursor-pointer">
                                                        <input wire:model="decimalDisplay"
                                                            @if ($decimalDisplay === '3') checked @endif
                                                            id="decimal-radio-1" name="decimal-radio"
                                                            type="radio" value="3"
                                                            class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                                    </div>
                                        ...
                                        <div class="mx-3 my-4">
                                            <button
                                                class="w-full p-1 text-sm bg-[#52D3A2] rounded text-center"
                                                id="decimalCloseButton">Show Result</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center mt-2 text-sm filters-row">
                            <b class="mr-3">Period Type:</b>
                            <ul class="flex items-center soft-radio-wrapper big-checked">
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="arf5drs"
                                            id="date-fiscal-annual" type="radio" name="date-range"
                                            class="w-5 h-5 ">
                                ...
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="qrf5drs"
                                            id="date-fiscal-quaterly" type="radio" name="date-range"
                                            class="w-5 h-5 ">
                                ...
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="fiscal-semi-annual"
                                            id="date-fiscal-semi-annual" type="radio" name="date-range"
                                            class="w-5 h-5 ">
                                ...
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="YTD" id="date-YTD"
                                            type="radio" name="date-range" class="w-5 h-5 ">
                                        <span class="w-full py-3 ml-2 ">YTD</span>
                                    </label>
                                </li>
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="LTM" id="date-LTM"
                                            type="radio" name="date-range" class="w-5 h-5 ">
                                ...
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="annual" id="date-annual"
                                            id="date-annual" type="radio" name="date-range"
                                            class="w-5 h-5 ">
                                ...
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="quarterly" id="date-quarterly"
                                            type="radio" name="date-range" class="w-5 h-5 ">
                                ...
                                <li class="mr-2">
                                    <label class="flex items-center pl-3 cursor-pointer">
                                        <input wire:model="period" value="SA" id="date-SA"
                                            type="radio" name="date-sa" class="w-5 h-5 ">
                        ...
                        <div class="my-2 years-range-wrapper" wire:ignore>
                        ...
                        @if (count($chartData))
                            <div class="flex flex-col w-full px-5 pb-5 my-4 bg-white">
                                <div class="flex justify-between w-10/12 pl-6 pr-3 my-12">
                                    <div class="text-lg font-bold text-indigo-600">
                                        Apple Inc. (AAPL)
                                    </div>
                                    <div class="flex items-start">
                                        <span wire:click="closeChart"
                                            class="flex items-center justify-center w-5 h-5 text-white bg-red-500 border-2 rounded-full">
                                ...
                                <div class="w-10/12 px-6">
                                    <canvas id="chart-company-report"></canvas>
                                </div>
                                <div
                                    class="flex flex-wrap items-end justify-start w-full px-2 mt-8 space-x-3 space-y-3">
                        ...
                        <div class="mt-5 warning-wrapper">
                        ...
                        <div class="flex w-full overflow-x-scroll">
                            <div class="w-full table-wrapper" style="font-size: 12px;">
                                <div class="table">
                                    <div class="row-group">
                                        <div class="flex flex-row bg-gray-200">
                                            <div
                                                class="w-[300px] font-bold flex py-4 items-center justify-start text-base">
                                                <span class="ml-8">
                                                    {{ $companyName }} ({{ $ticker }})
                                                </span>
                                            </div>
                                            <div class="flex flex-row justify-end w-full bg-gray-200">
                                            ...
                                            @if (!$tableLoading)
                                                @foreach ($rows as $row)
                                                    <livewire:company-report-table-row :data="$row"
                                                        key="{{ now() }}" :selectedRows="array_keys($this->selectedRows)"
                                                        :reverse="$reverse" />
                                                @endforeach
                                            @endif
                                        </div>
                ...
                <div class="flex w-[90%] overflow-x-hidden">
                    <div class="flex tabs-wrapper">
                        <a href="{{ route('company.report', ['ticker' => $company->ticker, 'period' => $period]) }}"
                            @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.report',
                            ])>Income Statement</a>
                        <a href="{{ route('company.metrics', ['ticker' => $company->ticker, 'period' => $period]) }}"
                            @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.metrics',
                            ])>Balance Sheet</a>
                        <a href="{{ route('company.filings', ['ticker' => $company->ticker, 'period' => $period]) }}"
                            @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.filings',
                            ])>Cash Flow</a>
                        <a href="{{ route('company.geographic', ['ticker' => $company->ticker, 'period' => $period]) }}"
                            @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.geographic',
                            ])>Segments</a>
                        <a href="{{ route('company.shareholders', ['ticker' => $company->ticker, 'period' => $period]) }}"
                            @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.shareholders',
                            ])>Ratios</a>
                        <a href="{{ route('company.executive.compensation', ['ticker' => $company->ticker, 'period' => $period]) }}"
                            @class([
                                'tab',
                                'px-3',
                                'active' => $currentRoute === 'company.executive.compensation',
                ...
                <div class="filters-row">
                    <div class="flex items-center select-wrapper">
                        <div class="flex items-center ml-3">View
                            <button type="submit" id="dropdownViewButton"
                                data-dropdown-toggle="dropdown-View"
                                class="flex items-center flowbite-select bg-gray-50 border border-gray-700 text-gray-900 text-sm ml-2 p-2.5"
                                name="view" id="">
                                {{ $view }}
                                    ...
                                    <li>
                                        <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                            <div class="flex items-center h-5 cursor-pointer">
                                                <input wire:model="view"
                                                    @if ($view === 'As reported (Harmonized)') checked @endif
                                                    id="view-radio-1" name="view-radio" type="radio"
                                                    value="As reported (Harmonized)"
                                                    class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                            </div>
                                            <div class="ml-4 text-sm cursor-pointer">
                                                <label for="view-radio-1"
                                    ...
                                    <li>
                                        <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                            <div class="flex items-center h-5 cursor-pointer">
                                                <input wire:model="view"
                                                    @if ($view === 'Standardised Template') checked @endif
                                                    id="view-radio-3" name="view-radio" type="radio"
                                                    value="Standardised Template"
                                                    class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                            </div>
                                            <div class="ml-4 text-sm cursor-pointer">
                                                <label for="view-radio-3"
                                    ...
                                    <li>
                                        <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                            <div class="flex items-center h-5 cursor-pointer">
                                                <input wire:model="view"
                                                    @if ($view === 'Common size') checked @endif
                                                    id="view-radio-5" name="view-radio" type="radio"
                                                    value="Common size"
                                                    class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                            </div>
                                            <div class="ml-4 text-sm cursor-pointer">
                            ...
                            <div id="dropdown-Order"
                                ...
                                <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                    ...
                                    <li>
                                        <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                            <div class="flex items-center h-5 cursor-pointer">
                                                <input wire:model="order"
                                                    @if ($order === 'Latest on the Right') checked @endif
                                                    id="order-radio-1" name="order-radio" type="radio"
                                                    value="Latest on the Right"
                                                    class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                            </div>
                                            <div class="ml-4 text-sm cursor-pointer">
                                                <label for="order-radio-1"
                                    ...
                                    <li>
                                        <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                            <div class="flex items-center h-5 cursor-pointer">
                                                <input wire:model="order"
                                                    @if ($order === 'Latest on the Left') checked @endif
                                                    id="order-radio-1" name="order-radio" type="radio"
                                                    value="Latest on the Left"
                                                    class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                            </div>
                                            <div class="ml-4 text-sm cursor-pointer">
                                                <label for="order-radio-1"
                            ...
                            <div id="dropdown-Decimal"
                                ...
                                <ul class="p-4 space-y-1 overflow-y-scroll text-sm text-gray-700 dark:text-gray-200 max-h-40"
                                    ...
                                    <li>
                                        <div class="flex p-2 rounded hover:bg-[#52D3A233] cursor-pointer">
                                            <div class="flex items-center h-5 cursor-pointer">
                                                <input wire:model="decimal"
                                                    @if ($view === '.00') checked @endif
                                                    id="decimal-radio-1" name="decimal-radio"
                                                    type="radio" value=".00"
                                                    class="cursor-pointer w-4 h-4 text-[#686868] bg-transpearent border-[#686868] border-2">
                                            </div>
                ...
                <div class="flex items-center mt-2 filters-row">
                    <b class="mr-3">Period Type:</b>
                    <ul class="flex items-center soft-radio-wrapper big-checked">
                        <li class="mr-2">
                            <label class="flex items-center pl-3 cursor-pointer">
                                <input wire:model="period" value="arf5drs" id="date-fiscal-annual"
                                    type="radio" name="date-range" class="w-5 h-5 ">
                                <span class="w-full py-3 ml-2 ">Fiscal Annual</span>
                            </label>
                        </li>
                        <li class="mr-2">
                            <label class="flex items-center pl-3 cursor-pointer">
                                <input wire:model="period" value="qrf5drs" id="date-fiscal-quaterly"
                                    type="radio" name="date-range" class="w-5 h-5 ">
                                <span class="w-full py-3 ml-2 ">Fiscal Quaterly</span>
                            </label>
                        </li>
                        ...
                        <li class="mr-2">
                            <label class="flex items-center pl-3 cursor-pointer">
                                <input wire:model="period" value="YTD" id="date-YTD" type="radio"
                        ...
                        <li class="mr-2">
                            <label class="flex items-center pl-3 cursor-pointer">
                                <input wire:model="period" value="LTM" id="date-LTM" type="radio"
                                    name="date-range" class="w-5 h-5 ">
                                <span class="w-full py-3 ml-2 ">LTM</span>
                            </label>
                        </li>
                        <li class="mr-2">
                            <label class="flex items-center pl-3 cursor-pointer">
                                <input wire:model="period" value="annual" id="date-annual"
                                    id="date-annual" type="radio" name="date-range" class="w-5 h-5 ">
                                <span class="w-full py-3 ml-2 ">Calendar Annual</span>
                            </label>
                        </li>
                        <li class="mr-2">
                        ...
                        <li class="mr-2">
                            <label class="flex items-center pl-3 cursor-pointer">
                                <input wire:model="period" value="SA" id="date-SA" type="radio"
                                    name="date-sa" class="w-5 h-5 ">
                                <span class="w-full py-3 ml-2 ">Calendar SA</span>
                            </label>
                        </li>
                    </ul>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.addEventListener('click', function(event) {
                ...
                if (element.classList.contains('open-slide') && !slideOpen) {
                    ...
                    window.livewire.emit('slide-over.open', 'company-report-slide', value, {
                        force: true
                    });
                    slideOpen = true;
                }
