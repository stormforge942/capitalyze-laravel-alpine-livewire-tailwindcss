...
{{--                            </div>--}}
                            <div class="py-2">
                                ...
                                <div class="years-range-wrapper my-2" wire:ignore>
                                    ...
                                    <div id="range-slider-company-metrics" class="range-slider"></div>
                                </div>
                                ...
                                <div class="table-wrapper" style="font-size: 12px;">
                                    <div class="table min-w-full data border-collapse">
                                        <div class="row row-head">
                                            <div class="cell font-bold">{{$this->company->name}}</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const el = document.querySelector('#range-slider-company-metrics');
