...
<div class="chart-builder-page">
        ...
        @foreach ($tabs as $tab)
            <div class="flex items-center gap-2" x-data="{
                ...
                save() {
                    this.edit = false;
                    if (this.value.trim()) {
                        window.http(`/chart-builder/{{ $tab['id'] }}/update`, {
                            method: 'POST',
    ...
    <div class="relative" wire:loading.class="pointer-events-none animate-pulse" wire:target="changeTab">
        ...
        <div x-data="{
            ...
            init() {
                ...
                this.$watch('filters', (filters) => {
                    window.http(`/chart-builder/${$wire.activeTab}/update`, {
                        method: 'POST',
                        body: { filters },
                    })
                }, { deep: true })
