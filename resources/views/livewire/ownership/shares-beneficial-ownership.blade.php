<div x-data="{
    ...
    <div class="grid grid-cols-12 mt-4 gap-x-4">
        <div class="col-span-12 xl:col-span-6">
            @include('livewire.ownership.shares-beneficial-ownership-table')
        </div>
        <div class="col-span-12 xl:col-span-6">
            <div class="block rounded rounded-lg border border-sky-950 overflow-hidden mt-4">
                <div
                    class="whitespace-nowrap px-2 py-3.5 text-left text-sm font-semibold text-white bg-sky-950 text-center">
                    <p>Shares Beneficially Ownership</p>
                </div>
                <canvas x-ref="chartShares" class="p-4"></canvas>
            </div>
        </div>
    </div>
</div>
