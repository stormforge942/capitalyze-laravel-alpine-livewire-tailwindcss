<div>
    <div class="grid grid-cols-12 gap-x-2 mb-2">
        <div class="col-span-4 bg-white flex items-center p-4 gap-x-4 border border-[#D4DDD7] rounded">
            ...
            <input type="search" placeholder="Search"
                class="placeholder:text-gray-medium2 border-none flex-1 focus:outline-none focus:ring-0 h-6"
                wire:model.debounce.500ms="search"
                >
        </div>

        <div class="col-span-8 px-4 bg-white flex items-center border border-[#D4DDD7] rounded">
