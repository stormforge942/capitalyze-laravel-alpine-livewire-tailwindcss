        ...
        <div class="px-4 sm:px-6 lg:px-8 bg-white py-4 shadow mx-4 rounded">
            <div class="sm:flex sm:items-start flex-col">
                <div class="block mb-3">
                    <h1 class="text-base font-semibold leading-10 text-gray-900">Mutual Fund Holdings - {{ isset($fund->registrant_name) ? Str::title($fund->registrant_name) : '' }} - {{ !empty($quarters) ? Str::title($quarters[$selectedQuarter]) : '' }}</h1>
                </div>
                <div class="block mb-3">
