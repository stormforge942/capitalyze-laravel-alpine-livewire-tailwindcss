        ...
        <div class="mx-auto">
            <div class="px-4 sm:px-6 lg:px-8 bg-white py-4 shadow mx-4 rounded">
                ...
                <div class="sm:flex sm:items-start flex-col" wire:loading.remove>
                    <div class="block">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Company Stock Splits</h1>
                    </div>
                    <table class="table-auto w-full overflow-scroll" wire:loading.remove>
                        <tr>
                            <td class="font-semibold py-4">Date</td>
                            <td class="font-semibold py-4">Stock Split</td>
                        </tr>
                        @foreach($stockSplits as $split)
                            <tr>
                                <td class="px-2">{{ $split->date }}</td>
                                <td class="px-2">{{ $split->split_factor }}</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
