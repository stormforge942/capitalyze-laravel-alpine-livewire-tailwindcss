...
}" class="flex items-center justify-between gap-x-5" x-modelable="value" x-model="selectedFinancialCriteria">
    <div class="flex items-center gap-x-2">
        <div wire:ignore>
            <x-dropdown x-model="showDropdown" placement="bottom-start" :fullWidthTrigger="true" :teleport="true">
                ...
                <span class="text-sm truncate" x-text="value.length > 0 ? getLabel(value[0].metric) : 'Choose Data'">
