<div class="flex items-center justify-between gap-x-5" x-data="{
    options: @js($this->stockExchanges),
    search: '',
    selectAll: false,
    tmpValue: {
        data: [],
    ...
    init() {
        ...
        this.$watch('selectAll', value => {
            this.tmpValue.data = value ? [...this.options] : []
        })
    }
}" x-modelable="value" x-model="stockExchanges">
            ...
            <div class="w-[20rem] sm:w-[26rem] h-[400px] !overflow-scroll">
                <div class="fixed top-0 left-0 z-50 bg-white">
                    <div class="flex justify-between items-start gap-2 px-6 pt-6">
                        <div>
                            <p class="font-medium text-base">Select Stock Exchange</p>
                        </div>
                ...
                <div class="p-4 py-2 relative z-0 my-[120px]">
