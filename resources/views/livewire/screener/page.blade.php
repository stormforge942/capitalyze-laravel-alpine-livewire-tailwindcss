<div x-data="{
    ...
    locations: $wire.entangle('locationsValue').defer || {
        data: [],
        exclude: false
    },
    sectors: $wire.entangle('sectorsValue').defer || {
        data: [],
        exclude: false
    },
    currencies: $wire.entangle('currenciesValue').defer || {
        data: [],
        exclude: false
    },
    decimal: $wire.entangle('decimalValue').defer || {
        decimalPlaces: 0,
    ...
    get disabledGetResultButton() {
        return this.selectedFinancialCriteria.some(item => item.value.length < 1)
    },
    onGetResult() {
        ...
        <div wire:loading.class="pointer-events-none animate-pulse"
            ...
            <div class="flex justify-between mb-6">
                <div>
                    ...
                    <p class="text-sm text-dark-light2">Create your own stock screener with 100+ different screening
                        criteria</p>
                </div>
                <div class="flex items-center gap-4">
                    @include('livewire.screener.select-summary')
                    <button
