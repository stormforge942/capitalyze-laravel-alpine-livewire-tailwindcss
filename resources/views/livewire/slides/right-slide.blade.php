<div class="fixed h-full shadow w-full modal_parent bg-white z-40 p-8 max-w-xl right-0 top-0">
    ...
    @if($loaded == false)
    <div class="flex w-full  items-center justify-center h-full" role="status">
