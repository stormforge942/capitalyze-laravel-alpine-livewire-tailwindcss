<div x-data="{ open: $wire.entangle('open'), load: $wire.loadData }">
    <template x-teleport=".wep-slide-over-container" wire:key="{{ $this->key() }}">
        <div class="wep-slide-over-container-inner" style="left: 0; padding-left: 0;">
            <div x-show="open" x-transition:enter="enter" x-transition:enter-start="start" x-transition:enter-end="end"
                x-transition:leave="leave" x-transition:leave-start="start" x-transition:leave-end="end"
                class="wep-slide-over-container-inner-wrap max-w-xl left-slide-inner-wrap">

                <div class="wep-slide-over-container-inner-content show-scrollbar" style="direction: rtl">
