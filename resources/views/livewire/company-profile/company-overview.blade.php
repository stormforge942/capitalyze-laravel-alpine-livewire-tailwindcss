<div>
        ...
        <div class="white-card market-card-holder">
            ...
            <div class="key-values-wrapper">
                ...
                <div class="key-value">
                    ...
                    <div class="value">{{ getLowPriceFromDashRange($profile['fiftytwo_week_range'] ?? null, '-') }}
                    </div>
                </div>
                <div class="key-value">
                    <div class="key">52 Week Low</div>
                    <div class="value">{{ getHighPriceFromDashRange($profile['fiftytwo_week_range'] ?? null, '-') }}
                    </div>
                </div>
    ...
    <div class="w-full mt-4 white-card c-profile-card" x-data="{
        ...
        <div class="title">
            ...
            <a class="title-spoiler title_smal" x-text="expand ? 'Hide full profile': 'View full profile'"
                @click="expand = !expand">
                Hide full profile
            </a>
        </div>
        <div class="flex flex-wrap mt-4 key-values-wrapper__item_parent">
            ...
            <div class="key-values-wrapper__item basis-3/6 lg:basis-1/6">
                ...
                <div class="key-value">
                    ...
                    <div class="value">
                        {{ @$profile['city'] }}@if (@$profile['country'] && @$profile['city'])
                            ,
                        @endif
                        {{ @$profile['country'] }}
                    </div>
            ...
            <div class="key-values-wrapper__item basis-3/6 lg:basis-1/6" x-show="expand">
