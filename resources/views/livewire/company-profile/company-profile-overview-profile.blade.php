<div class="white-card w-full mt-4">
    ...
    <div class="flex key-values-wrapper__item_parent  flex-wrap mt-4">
            ...
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <g clip-path="url(#clip0_301_52187)">
                        ...
                        <path d="M8 5.5C8.27614 5.5 8.5 5.27614 8.5 5C8.5 4.72386 8.27614 4.5 8 4.5C7.72386 4.5 7.5 4.72386 7.5 5C7.5 5.27614 7.72386 5.5 8 5.5Z" fill="#A6A6A6"/>
                        <path d="M13.75 9.75V3.5H14.75V9.75" fill="#5C6373"/>
                        <path d="M1.5 10C1.77614 10 2 9.77614 2 9.5C2 9.22386 1.77614 9 1.5 9C1.22386 9 1 9.22386 1 9.5C1 9.77614 1.22386 10 1.5 10Z" fill="#A6A6A6"/>
                        <path d="M14.25 12C14.9404 12 15.5 11.4404 15.5 10.75C15.5 10.0596 14.9404 9.5 14.25 9.5C13.5596 9.5 13 10.0596 13 10.75C13 11.4404 13.5596 12 14.25 12Z" fill="#A6A6A6"/>
                        <path d="M10.5 15.5L9.25 6.5H6.75L5.5 15.5H10.5Z" fill="#121A0F"/>
                        <path d="M9.74687 10.1L9.62187 9.275L6.84687 6.5H6.74687L6.67188 7.025L9.74687 10.1Z" fill="#121A0F"/>
                        <path d="M9.25 6.5H9.15L6.375 9.275L6.25 10.1L9.325 7.025L9.25 6.5Z" fill="#121A0F"/>
                        <path d="M6.04688 11.6L10.3719 15.5H10.4969L10.3969 14.85L6.12187 11L6.04688 11.6Z" fill="#121A0F"/>
                        ...
                        <path d="M12.175 3.5H12.75V3.475V2.6L13.675 3.5H14.25V3.475V2.6L15.175 3.5H15.5V3.125L14.35 2H13.75V2.875L12.85 2H12.25V2.875L11.35 2H10.75V2.9L9.85 2H9.25V2.875L8.35 2H7.75V2.875L6.85 2H6.25V2.875L5.35 2H4.75V2.875L3.85 2H3.25V2.9L2.35 2H2V2.35L3.15 3.5H3.75V2.6L4.675 3.5H5.25V3.475V2.6L6.175 3.5H6.75V3.475V2.6L7.675 3.5H8.25V3.475V2.6L9.175 3.5H9.75V3.475V2.6L10.65 3.5H11.25V2.6L12.175 3.5Z" fill="#121A0F"/>
                        <path d="M2 1.75H0.5V2.25H2V1.75Z" fill="#121A0F"/>
                        <path d="M2 2.75H0.5V3.25H2V2.75Z" fill="#121A0F"/>
                        <path d="M0.646875 4.25H1.99688V3.75H0.546875C0.571875 3.925 0.596875 4.075 0.646875 4.25Z" fill="#121A0F"/>
        ...
        <div class="key-values-wrapper__item basis-3/6 lg:basis-1/6">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M3.33333 2V12.6667H14V14H2V2H3.33333ZM13.2929 3.95956L14.7071 5.37377L10.6667 9.4142L8.66667 7.414L6.04044 10.0405L4.62623 8.6262L8.66667 4.58579L10.6667 6.586L13.2929 3.95956Z" fill="#121A0F"/>
                </svg>
            </div>
            <div class="key-value">
        ...
        <div class="key-values-wrapper__item basis-3/6 lg:basis-1/6">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M1.36621 8.66657H5.01816C5.13749 10.8458 5.83826 12.8701 6.968 14.5872C3.99174 14.1246 1.66673 11.6934 1.36621 8.66657ZM1.36621 7.33324C1.66673 4.30637 3.99174 1.87509 6.968 1.4126C5.83826 3.12962 5.13749 5.15399 5.01816 7.33324H1.36621ZM14.6337 7.33324H10.9817C10.8624 5.15399 10.1617 3.12962 9.03193 1.4126C12.0082 1.87509 14.3332 4.30637 14.6337 7.33324ZM14.6337 8.66657C14.3332 11.6934 12.0082 14.1246 9.03193 14.5872C10.1617 12.8701 10.8624 10.8458 10.9817 8.66657H14.6337ZM6.35378 8.66657H9.64613C9.53173 10.5218 8.94306 12.2487 7.99993 13.7276C7.0568 12.2487 6.46819 10.5218 6.35378 8.66657ZM6.35378 7.33324C6.46819 5.47798 7.0568 3.75106 7.99993 2.27219C8.94306 3.75106 9.53173 5.47798 9.64613 7.33324H6.35378Z" fill="#121A0F"/>
                </svg>
            </div>
            <div class="key-value">
                ...
                <div class="value">
                    @if (@$profile['website'])
                        <a target="_blank"
                           href="{{ $profile['website'] }}">{{ getSiteNameFromUrl($profile['website']) }}</a>
                    @else
                        -
                    @endif
                </div>
        ...
        </div> <div class="key-values-wrapper__item basis-3/6 lg:basis-1/6">
            <div class="key-values-none">
