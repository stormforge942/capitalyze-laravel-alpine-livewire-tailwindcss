    ...
    <div class=" bg-[#fff] p-3">
        <div class="flex justify-between items-center content-center">
            ...
            <div class="flex justify-between items-center">
                <img class="mr-3" src="{{asset('/svg/zoom-out.svg')}}" alt="zoom out"/>
                <img class="mr-3" src="{{asset('/svg/zoom-in.svg')}}" alt="zoom in"/>
                <img class="mr-3" src="{{asset('/svg/rotate.svg')}}" alt="rotate"/>
                <img class="mr-3 cursor-pointer" @click="open = false" src="{{asset('/svg/close-cross-circle.svg')}}" alt="close cross circle"/>
            </div>
        </div>
    </div>    
