<div x-data="{
    ...
    curInvestors: $wire.entangle('curInvestors').defer,
    ...
    <div class="grid place-items-center py-24" x-show="! curInvestors.length">
    ...
    <div class="mt-6" x-show="curInvestors.length">
        <div class="flex gap-x-4">
            <div class="w-1/2 lg:w-4/9 xl:w-4/15 rounded-lg">
                <div
                    class="py-3 font-semibold text-md bg-white text-black flex flex-row justify-center items-center rounded-lg">
                    Investor List
                    <span class="ml-2 rounded-full bg-black text-white text-sm px-1"
                        x-text="curInvestors.length"></span>
                </div>
                <div class="my-3 py-3 px-4 bg-white rounded-lg">
                    <div>
            ...
            <div class="w-1/2 lg:w-5/9 xl:w-11/15">
                <div class="col-span-5 py-10 grid place-items-center" x-show="loading">
                    <span class="mx-auto simple-loader !text-green-dark"></span>
                </div>
            
                <div class="w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-6" x-show="!loading">
                                    ...
                                    <div class="mb-3 px-2 py-3 bg-white rounded-lg">
                                        ...
                                        <div class="my-3 mx-2">
                                            <div x-show="getNewPosition(investor.funds).length"
                                                class="flex flex-row text-sm bg-[#FAFAFA] p-2 rounded-lg">
                                                <div class="pt-0.5">
                                                    <svg width="16px" height="16px">
                                            ...
                                            <div x-show="getIncreasedPosition(investor.funds).length"
                                                class="flex flex-row text-sm bg-[#FAFAFA] p-2 rounded-lg mt-3">
                                                <div class="pt-0.5">
                                                    <svg width="16px" height="16px">
                                                        <circle cx="8" cy="8" r="6"
                                                            fill="green" />
