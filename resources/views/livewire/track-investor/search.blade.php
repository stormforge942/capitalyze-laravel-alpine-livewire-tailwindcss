<div class="flex items-center border-b border-[#828C85] focus-within:border-dark-light2 pl-1 md:pl-4 py-2.5 gap-x-1 lg:gap-x-4 text-dark-light2">
    ...
    <input type="search"
        ...
        placeholder="Search funds..." x-model.debounce="search">
</div>