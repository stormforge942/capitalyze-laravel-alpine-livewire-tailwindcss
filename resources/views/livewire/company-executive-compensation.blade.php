        ...
        <div class="mx-auto">
            <div class="px-4 sm:px-6 lg:px-8 bg-white py-4 shadow mx-4 rounded">
                <div class="sm:flex sm:items-start flex-col">
                    ...
                    <select wire:model="selectedFilingDate" id="date-select" class="inline-flex px-3 py-2 pr-8 leading-tight border rounded appearance-none bg-slate-50 border-slate-300 text-slate-700 focus:outline-none focus:bg-white focus:border-slate-500">
                        <option disabled selected value=""> -- select an option -- </option>
                        @foreach ($executiveCompensations as $date)
                    ...
                    <div class="mt-8 flow-root rounded-lg overflow-x-auto w-full" wire:loading.remove>
                        <div class="align-middle">
                            ...
                            <div class="justify-center items-center min-w-full hidden" id="preloader">
                            ...
                            <div class="inline-block min-w-full sm:rounded-lg" wire:model="table" id="company-executive-compensation">
                                <livewire:company-executive-compensation-table :symbol="$ticker" :current_filing_date="$selectedFilingDate" />
                            </div>
                        </div>
                    </div>
                </div>
