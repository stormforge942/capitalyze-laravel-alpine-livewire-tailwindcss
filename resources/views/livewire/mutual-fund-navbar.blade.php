   ...
   <div>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            @foreach ($navbarItems as $navbar)
               @if ($navbar->is_moddable && $this->showNavbar($navbar->id) && !Str::startsWith($navbar->route_name, ['company.', 'lse.', 'tsx.', 'fund.', 'mutual-fund.', 'shanghai.', 'japan.', 'hkex.', 'otc.', 'euronext.','economics-release', 'create', 'frankfurt']))
                  <li>
