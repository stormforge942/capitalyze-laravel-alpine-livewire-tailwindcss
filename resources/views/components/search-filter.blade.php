<div class="bg-white flex items-center py-4 pl-4 pr-2 border border-[#D4DDD7] rounded-lg">
    ...
    <input type="search" placeholder="{{ $placeholder }}"
        class="placeholder:text-gray-medium2 border-none flex-1 focus:outline-none focus:ring-0 h-[30px] min-w-0 search-x-button placeholder:text-sm+ placeholder:font-medium"
        {{ $attributes }}>
</div>
