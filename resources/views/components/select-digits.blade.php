<div x-data="{
    ...
    init() {
        this.$nextTick(() => {
            ...
            @else
            const values = this.options.map(option => String(option[0]));
        ...
        this.$watch('selectAll', value => {
            this.tmpValue = value ? this.options.map(option => String(option[0])) : []
        })
    },
        ...
        <form class="w-[20rem] sm:w-[26rem]">
            ...
            <div class="max-h-[19rem] overflow-y-auto dropdown-scroll mr-1">
                <div class="space-y-2 px-6">
                    <template x-for="[key, value] of computedOptions" :key="'a' + key">
                    ...
                    <template x-if="!computedOptions.length">
            ...
            <div class="p-6">
                <button type="button"
                    ...
                    @click="value = tmpValue; showDropdown = false; $dispatch('selected', { selected: tmpValue });"
