        ...
        x-show="active">
            <div class="wep-spotlight-input-container">
                ...
                <div class="wep-spotlight-input-inner-container" wire:key="spotlight-input">
                    ...
                    <input type="text" tabindex="0" x-bind="input" wire:model.debounce.{{ $this->config('default-behavior.debounce_milliseconds') }}ms="query" x-bind:placeholder="selection()?.typeahead ?? selection()?.title ?? '{{ __('wire-elements-pro::spotlight.search_or_jump_to') }}'" class="wep-spotlight-input">
                </div>
            </div>
