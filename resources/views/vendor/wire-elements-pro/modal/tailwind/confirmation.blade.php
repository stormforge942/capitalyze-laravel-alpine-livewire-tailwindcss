<x-wire-elements-pro::tailwind.modal onSubmit="confirm" :contentPadding="false">
    ...
    <x-slot name="buttons">
        <div class="flex justify-between w-full">
            ...
            <button type="submit" class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 focus:outline-none" wire:loading.attr="disabled">
                {{ $prompt['confirm'] }}
            </button>
        </div>
    </x-slot>
