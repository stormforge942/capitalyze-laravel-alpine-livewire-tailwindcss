<div>
    <label
        ...
        <span
            class="text-gray-medium2 transition-all absolute left-4 @if(old($name)) top-4 text-sm @else top-[50%] @endif -translate-y-[50%] peer-focus-within:top-4 peer-focus-within:text-sm">
            {{ $label ?? '' }}
        </span>
    </label>
