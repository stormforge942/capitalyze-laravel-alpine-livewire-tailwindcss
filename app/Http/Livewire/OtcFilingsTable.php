...
final class OtcFilingsTable extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('url', function (OtcFilings $otcFilings) {
                return ('<a class="text-blue-500" target="_blank"  href="'.$otcFilings->url.'">More Info</a>');
            });
    }
