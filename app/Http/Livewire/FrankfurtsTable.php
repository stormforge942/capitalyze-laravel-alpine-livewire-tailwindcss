...
final class FrankfurtsTable extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('symbol', function(Frankfurts $model) {
                return("<a class='text-blue-500' href='/frankfurt/$model->symbol'>$model->symbol</a>");
            })
