    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('class_id', 'class_id')->sortable(),
            Column::make('acceptance_time', 'acceptance_time')->sortable(),
            Column::make('period_of_report', 'period_of_report')->sortable(),
            ...
            Column::make('payoff_profile', 'payoff_profile')->sortable(),
            Column::make('asset_cat', 'asset_cat')->sortable(),
            Column::make('issuer_cat', 'issuer_cat')->sortable(),
            Column::make('inv_country', 'inv_country')->sortable(),
            Column::make('is_restricted_sec', 'is_restricted_sec')->sortable(),
            Column::make('fair_val_level', 'fair_val_level')->sortable(),
            Column::make('is_cash_collateral', 'is_cash_collateral')->sortable(),
            Column::make('is_non_cash_collateral', 'is_non_cash_collateral')->sortable(),
            Column::make('is_loan_by_fund', 'is_loan_by_fund')->sortable()
        ];
    }
