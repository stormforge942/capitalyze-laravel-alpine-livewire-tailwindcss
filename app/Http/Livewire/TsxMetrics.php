...
class TsxMetrics extends Component
{
    public $tsx;
    public $table;
    public $metrics;
        ...
        foreach($this->segments as $segment) {
            ...
            foreach(array_keys($this->metrics) as $date) {
                if(array_key_exists($segment, $this->metrics[$date])) {
                    ...
                    $dataSend = array("symbol" => $this->tsx->symbol, "source" => 'public.tsx_statements', "date" => $date, "value" => $data);
    ...
    {
        return view('livewire.tsx-metrics');
    }
}
