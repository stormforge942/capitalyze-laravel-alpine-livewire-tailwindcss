...
class RegistrationsAndProspectuses extends Component
{
    public $checkedCount;
    public $data = [];
    ...
    public function mount(){
        $filtered = falingsSummaryTabFilteredValue('registrations-and-prospectuses')['params'];
    ...
    {
        return view('livewire.all-filings.registrations-and-prospectuses');
    }
}
