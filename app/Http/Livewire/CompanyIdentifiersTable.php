...
use App\Models\CompanyIdentifiers;
...
final class CompanyIdentifiersTable extends PowerGridComponent
{
    use ActionButton;
    use WithExport;

    public bool $deferLoading = false; // default false
    public string $sortField = 'symbol';
    ...
    */
    ...
    {
        $query = CompanyIdentifiers::query();
