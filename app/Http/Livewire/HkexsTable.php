...
final class HkexsTable extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('symbol', function(Hkexs $hkexs) {
                return("<a class='text-blue-500' href='/hkex/$hkexs->symbol'>$hkexs->symbol</a>");
            })
